    ...
    <section id="privacyPolicy">
      <div class="sectionWrapper">
        ...
        <p>
          ...
          this website, www.spottingthelight.com (the "Website"), Spotting the
          Light ("Business Name") offer of products for purchase on this
          Website, or your purchase of products available on this Website. This
          Agreement includes, and incorporates by this reference, the policies
          and guidelines referenced below. Spotting the Light reserves the right
          ...
          Spotting the Light will alert you that changes or revisions have been
          made by indicating on the top of this Agreement the date it was last
          ...
          revisions. Spotting the Light encourages you to review this Agreement
          ...
          agreement you may have with Spotting the Light for other products or
        ...
        <p>
          ...
          reps or direct Spotting the Light sales reps, while they are calling
          ...
          receive further emails and call solicitations Spotting the Light and
        ...
        <p>
          ...
          via sending your email address to: info@spottingthelight.com.
        </p>
        <p>
          Proprietary Rights. Spotting the Light has proprietary rights and
          trade secrets in the Products. You may not copy, reproduce, resell or
          redistribute any Product manufactured and/or distributed by Spotting
          the Light. Spotting the Light also has rights to all trademarks and
        ...
        <p>
          ...
          nutritional and dietary supplements. Spotting the Light does not
          ...
          Spotting the Light does create the content on this Website, such
          ...
          provided solely as a convenience to you. Spotting the Light does not
          endorse the contents on any such third-party websites. Spotting the
          Light is not responsible for the content of or any damage that may
        ...
        <p>
          Use of Website; Spotting the Light is not responsible for any damages
        ...
        <p>
          ...
          written authorization from Spotting the Light or the applicable third
        ...
        <p>
          ...
          BASIS. Spotting the Light EXPRESSLY DISCLAIMS ALL WARRANTIES OF ANY
          ...
          PRODUCTS. ("PRODUCTS" INCLUDE TRIAL PRODUCTS.)
        </p>

        <h3>LIMITATION OF LIABILITY</h3>
        <p>
          Spotting the Light ENTIRE LIABILITY, AND YOUR EXCLUSIVE REMEDY, IN
        ...
        <p>
          Spotting the Light WILL NOT BE LIABLE FOR ANY DIRECT, INDIRECT,
        ...
        <p>
          You will release, indemnify, defend and hold harmless Spotting the
          Light, and any of its contractors, agents, employees, officers,
          ...
          supplied to Spotting the Light. When Spotting the Light is threatened
          with suit or sued by a third party, Spotting the Light may seek
          written assurances from you concerning your promise to indemnify
          Spotting the Light; your failure to provide such assurances may be
          considered by Spotting the Light to be a material breach of this
          Agreement. Spotting the Light will have the right to participate in
          any defense by you of a third-party claim related to your use of any
          of the Website content or Products, with counsel of Spotting the Light
          choice at its expense. Spotting the Light will reasonably cooperate in
          any defense by you of a third-party claim at your request and expense.
          You will have sole responsibility to defend Spotting the Light against
          any claim, but you must receive Spotting the Light prior written
        ...
        <h3>PRIVACY</h3>
        <p>
          Spotting the Light believes strongly in protecting user privacy and
          providing you with notice of MuscleUP Nutrition 's use of data. Please
          refer to Spotting the Light privacy policy, incorporated by reference
        ...
        <h3>GENERAL</h3>
        <p>
          Force Majeure. Spotting the Light will not be deemed in default
        ...
        <p>
          Cessation of Operation. Spotting the Light may at any time, in its
        ...
        <p>
          ...
          between you and Spotting the Light and supersedes any prior agreements
          pertaining to the subject matter contained herein.
        </p>

        <p>
          Effect of Waiver. The failure of Spotting the Light to exercise or
        ...
        <p>
          Termination. Spotting the Light reserves the right to terminate your
          ...
          use the Website and Spotting the Light may, in its sole discretion and
          without advance notice to you, cancel any outstanding orders for
          Products. If your access to the Website is terminated, Spotting the
          Light reserves the right to exercise whatever means it deems necessary
          to prevent unauthorized access of the Website. This Agreement will
          survive indefinitely unless and until Spotting the Light chooses, in
